...
def save_cookies(cookies):
    pickle.dump(cookies, open(r"/home/liuchao/documents/hbyunan.pkl", 'wb'))

# 加载 cookie
def load_cookies(driver):
    cookies = pickle.load(open(r"/home/liuchao/documents/hbyunan.pkl", 'rb'))
...
def login():
    ...
    driver = webdriver.Chrome(r"/home/liuchao/opt")
    # 打开网易邮箱登录页面
